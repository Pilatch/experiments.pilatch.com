...
var author$project$Iterations$View$card0 = elm$html$Html$Attributes$class('player-hand hand-size-4 card-0');
var author$project$Iterations$View$card1 = elm$html$Html$Attributes$class('player-hand hand-size-4 card-1');
var author$project$Iterations$View$card2 = elm$html$Html$Attributes$class('player-hand hand-size-4 card-2');
var author$project$Iterations$View$card3 = elm$html$Html$Attributes$class('player-hand hand-size-4 card-3');
...
var author$project$Iterations$View$blank = A2(elm$html$Html$Attributes$attribute, 'nothing', '');
var elm$virtual_dom$VirtualDom$node = function (tag) {
	return _VirtualDom_node(
		_VirtualDom_noScript(tag));
};
var elm$html$Html$node = elm$virtual_dom$VirtualDom$node;
var author$project$Iterations$View$pCard = function (attributes) {
	return A3(elm$html$Html$node, 'pilatch-card', attributes, _List_Nil);
};
var author$project$Iterations$View$placedAreaClass = elm$html$Html$Attributes$class('player-placed-card-area');
var author$project$Iterations$View$emptyArea = author$project$Iterations$View$pCard(
	_List_fromArray(
		[author$project$Iterations$View$placedAreaClass, author$project$Iterations$View$blank]));
var author$project$Iterations$View$rank = elm$html$Html$Attributes$attribute('rank');
var author$project$Iterations$View$suit = elm$html$Html$Attributes$attribute('suit');
var author$project$Iterations$View$up = A2(elm$html$Html$Attributes$attribute, 'up', '');
var author$project$Iterations$View$fiveOfPaper = function (attribute) {
	return author$project$Iterations$View$pCard(
		_List_fromArray(
			[
				attribute,
				author$project$Iterations$View$up,
				author$project$Iterations$View$rank('5'),
				author$project$Iterations$View$suit('paper')
			]));
};
var author$project$Iterations$View$fiveOfPaper2 = F2(
...
var author$project$Iterations$View$fiveOfPaperDown2 = F2(
	function (attribute1, attribute2) {
		return author$project$Iterations$View$pCard(
			_List_fromArray(
				[
...
var author$project$Iterations$View$kingOfRock = function (attribute) {
	return author$project$Iterations$View$pCard(
		_List_fromArray(
			[
				attribute,
				author$project$Iterations$View$up,
				author$project$Iterations$View$rank('13'),
				author$project$Iterations$View$suit('rock')
			]));
};
var author$project$Iterations$View$kingOfRock2 = F2(
	function (attribute1, attribute2) {
		return author$project$Iterations$View$pCard(
			_List_fromArray(
				[
...
var author$project$Iterations$View$noTransition = A2(elm$html$Html$Attributes$attribute, 'no-transition', '');
var author$project$Iterations$View$queenOfScissors = function (attribute) {
	return author$project$Iterations$View$pCard(
		_List_fromArray(
			[
				attribute,
				author$project$Iterations$View$up,
				author$project$Iterations$View$rank('12'),
				author$project$Iterations$View$suit('scissors')
			]));
};
var author$project$Iterations$View$queenOfScissors2 = F2(
	function (attribute1, attribute2) {
		return author$project$Iterations$View$pCard(
			_List_fromArray(
				[
...
var author$project$Iterations$Model$DoAnimation = function (a) {
	return {$: 'DoAnimation', a: a};
};
...
var author$project$Iterations$View$next = function (animationNumber) {
	return A2(
		elm$html$Html$button,
		_List_fromArray(
			[
				elm$html$Html$Events$onClick(
				author$project$Iterations$Model$DoAnimation(animationNumber))
			]),
		_List_fromArray(
			[
...
var author$project$Iterations$View$tableTop = elm$html$Html$div(
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('table-top')
		]));
var elm$html$Html$section = _VirtualDom_node('section');
var author$project$Iterations$View$render = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$Iterations$View$next(animationNumber + 1),
							elm$html$Html$text(
							comment + ('. Animation: ' + elm$core$String$fromInt(animationNumber + 1)))
						])),
					author$project$Iterations$View$tableTop(cards)
				]));
	});
var author$project$Iterations$View$tableTop1 = function (attribute) {
...
var author$project$Iterations$View$renderNoTransition = F3(
	function (animationNumber, comment, cards) {
		return A2(
			elm$html$Html$section,
			_List_Nil,
			_List_fromArray(
				[
					...
					A2(author$project$Iterations$View$tableTop1, author$project$Iterations$View$noTransition, cards)
				]));
	});
var author$project$Iterations$Model$StartOver = {$: 'StartOver'};
var author$project$Iterations$View$startOver = A2(
	elm$html$Html$section,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Events$onClick(author$project$Iterations$Model$StartOver)
				]),
			_List_fromArray(
				[
					elm$html$Html$text('START OVER')
				])),
			author$project$Iterations$View$tableTop(_List_Nil)
		]));
var author$project$Iterations$View$threeOfRock = function (attribute) {
	return author$project$Iterations$View$pCard(
		_List_fromArray(
			[
				attribute,
				author$project$Iterations$View$up,
				author$project$Iterations$View$rank('3'),
				author$project$Iterations$View$suit('rock')
			]));
};
var author$project$Iterations$View$threeOfRock2 = F2(
	function (attribute1, attribute2) {
		return author$project$Iterations$View$pCard(
			_List_fromArray(
				[
...
var author$project$Iterations$View$collapsedImplementation = function (animationNumber) {
	switch (animationNumber) {
		case 0:
			return A3(
				author$project$Iterations$View$render,
				animationNumber,
				'Initial setup with four cards in hand and an empty placed card area',
				_List_fromArray(
					[
						A2(author$project$Iterations$View$queenOfScissors2, author$project$Iterations$View$card0, author$project$Iterations$View$noTransition),
						A2(author$project$Iterations$View$fiveOfPaper2, author$project$Iterations$View$card1, author$project$Iterations$View$noTransition),
						A2(author$project$Iterations$View$kingOfRock2, author$project$Iterations$View$card2, author$project$Iterations$View$noTransition),
						A2(author$project$Iterations$View$threeOfRock2, author$project$Iterations$View$card3, author$project$Iterations$View$noTransition),
						author$project$Iterations$View$emptyArea
					]));
		case 1:
			return A3(
				author$project$Iterations$View$render,
				...
				_List_fromArray(
					[
						author$project$Iterations$View$queenOfScissors(author$project$Iterations$View$card0),
						author$project$Iterations$View$pCard(
						_List_fromArray(
							[
								author$project$Iterations$View$card1,
								author$project$Iterations$View$placedAreaClass,
								author$project$Iterations$View$rank('5'),
								author$project$Iterations$View$suit('paper')
							])),
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card1),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$emptyArea
					]));
		case 2:
			return A3(
				author$project$Iterations$View$renderNoTransition,
				animationNumber,
				'move it in the DOM with transitions disabled in CSS',
				_List_fromArray(
					[
						author$project$Iterations$View$queenOfScissors(author$project$Iterations$View$card0),
						A2(author$project$Iterations$View$kingOfRock2, author$project$Iterations$View$card1, author$project$Iterations$View$noTransition),
						A2(author$project$Iterations$View$threeOfRock2, author$project$Iterations$View$card2, author$project$Iterations$View$noTransition),
						A2(author$project$Iterations$View$fiveOfPaperDown2, author$project$Iterations$View$placedAreaClass, author$project$Iterations$View$noTransition),
						author$project$Iterations$View$emptyArea
					]));
		case 3:
			return A3(
				...
				_List_fromArray(
					[
						...
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card1),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$fiveOfPaper(author$project$Iterations$View$card3),
						author$project$Iterations$View$emptyArea
					]));
		default:
			return author$project$Iterations$View$startOver;
	}
};
var author$project$Iterations$View$fiveOfPaperDown = function (attribute) {
	return author$project$Iterations$View$pCard(
		_List_fromArray(
			[
				attribute,
...
var author$project$Iterations$View$disablingTransitionsImplementation = function (animationNumber) {
	switch (animationNumber) {
		case 0:
			return A3(
				author$project$Iterations$View$render,
			...
			return A3(
				...
				_List_fromArray(
					[
						...
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card3),
						author$project$Iterations$View$emptyArea
					]));
		case 2:
			return A3(
				...
				_List_fromArray(
					[
						author$project$Iterations$View$queenOfScissors(author$project$Iterations$View$card0),
						author$project$Iterations$View$fiveOfPaperDown(author$project$Iterations$View$placedAreaClass),
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card3),
						author$project$Iterations$View$emptyArea
					]));
...
var author$project$Iterations$View$hidden = A2(elm$html$Html$Attributes$attribute, 'hidden', '');
var author$project$Iterations$View$invisible = author$project$Iterations$View$pCard(
	_List_fromArray(
		[author$project$Iterations$View$hidden]));
var author$project$Iterations$View$invisibleCardImplementation = function (animationNumber) {
	switch (animationNumber) {
		case 0:
			return A3(
				author$project$Iterations$View$render,
				...
				_List_fromArray(
					[
						author$project$Iterations$View$queenOfScissors(author$project$Iterations$View$card0),
						author$project$Iterations$View$fiveOfPaper(author$project$Iterations$View$card1),
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card3),
						author$project$Iterations$View$invisible,
						author$project$Iterations$View$emptyArea
					]));
		case 1:
			return A3(
				...
				_List_fromArray(
					[
						author$project$Iterations$View$queenOfScissors(author$project$Iterations$View$card0),
						author$project$Iterations$View$fiveOfPaper(author$project$Iterations$View$hidden),
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card3),
						author$project$Iterations$View$fiveOfPaper(author$project$Iterations$View$card1),
						author$project$Iterations$View$emptyArea
		...
		case 4:
			return A3(
				...
				_List_fromArray(
					[
						author$project$Iterations$View$queenOfScissors(author$project$Iterations$View$card0),
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$hidden),
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card1),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$fiveOfPaperDown(author$project$Iterations$View$placedAreaClass),
						author$project$Iterations$View$emptyArea
			...
			return A3(
				...
				_List_fromArray(
					[
						...
						author$project$Iterations$View$kingOfRock(author$project$Iterations$View$card1),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$card2),
						author$project$Iterations$View$threeOfRock(author$project$Iterations$View$hidden),
						author$project$Iterations$View$fiveOfPaperDown(author$project$Iterations$View$placedAreaClass),
						author$project$Iterations$View$emptyArea
					]));
		case 7:
...
var author$project$Iterations$View$naiveImplementation = function (animationNumber) {
	switch (animationNumber) {
		case 0:
			return A3(
				author$project$Iterations$View$render,
...
var author$project$Iterations$View$sourceCodezLink = A2(
	elm$html$Html$a,
	_List_fromArray(
		[
			elm$html$Html$Attributes$href('https://github.com/Pilatch/experiments.pilatch.com/tree/master/card-animation')
		]),
	_List_fromArray(
		[
			elm$html$Html$text('Source codez')
		]));
...
_Platform_export({'Iterations':{'Main':{'init':author$project$Iterations$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Iterations.Model.Msg","aliases":{},"unions":{"Iterations.Model.Msg":{"args":[],"tags":{"ChooseImplementation":["Iterations.Model.Implementation"],"DoAnimation":["Basics.Int"],"StartOver":[]}},"Iterations.Model.Implementation":{"args":[],"tags":{"NoneChosen":[],"Naive":[],"InvisibleCard":[],"DisablingTransitions":[],"Collapsed":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}}});}(this));