...
var _user$project$Explanation_Model$NaiveRearrange = {ctor: 'NaiveRearrange'};
...
var _user$project$Explanation_Model$DemoPlaceCard = function (a) {
	return {ctor: 'DemoPlaceCard', _0: a};
};
var _user$project$Explanation_Model$initialNoSeed = function (hand) {
	return {
		ctor: '_Tuple2',
		_0: {
			game: {
...
var _user$project$Explanation_Model$initialCommand = F2(
	function (seedInt, handSize) {
		var _p1 = A2(
			_elm_lang$core$Random$step,
			A2(_elm_lang$core$Random$int, 0, handSize - 1),
			_elm_lang$core$Random$initialSeed(seedInt));
		var cardIndex = _p1._0;
		var steppedSeed = _p1._1;
		return {
			ctor: '_Tuple2',
			_0: A2(
				_elm_lang$core$Task$perform,
				function (_p2) {
					return _user$project$Explanation_Model$DemoPlaceCard(cardIndex);
				},
				_elm_lang$core$Process$sleep(2000)),
			_1: steppedSeed
		};
	});
var _user$project$Explanation_Model$initial = F2(
	function (hand, seedInt) {
		var _p3 = A2(
			_user$project$Explanation_Model$initialCommand,
			seedInt,
			_elm_lang$core$List$length(hand));
		var command = _p3._0;
		var steppedSeed = _p3._1;
		return {
			ctor: '_Tuple2',
			_0: {
				game: {
...
var _user$project$Explanation_Model$RearrangeAfterAnimation = F2(
	function (a, b) {
...
var _user$project$Explanation_Update$naiveUpdate = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _user$project$Explanation_Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _user$project$Explanation_Model$initial(
			{
				ctor: '::',
		...
		view: _user$project$Explanation_View$view,
		update: _user$project$Explanation_Update$update,
		subscriptions: function (_p0) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})(_elm_lang$core$Json_Decode$int);

var _user$project$Explanation_Naive$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Explanation_Model$initialNoSeed(
			{
				ctor: '::',
				_0: _user$project$Card$OneOfScissors,
				_1: {
					ctor: '::',
					_0: _user$project$Card$TwoOfScissors,
					_1: {
						ctor: '::',
						_0: _user$project$Card$ThreeOfScissors,
						_1: {
							ctor: '::',
							_0: _user$project$Card$FourOfScissors,
							_1: {
								ctor: '::',
								_0: _user$project$Card$FiveOfScissors,
								_1: {ctor: '[]'}
							}
						}
					}
		...
		view: _user$project$Explanation_View$view,
		update: _user$project$Explanation_Update$naiveUpdate,
		subscriptions: function (_p0) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();
...
if (typeof _user$project$Explanation_Main$main !== 'undefined') {
    _user$project$Explanation_Main$main(Elm['Explanation']['Main'], 'Explanation.Main', undefined);
}
Elm['Explanation'] = Elm['Explanation'] || {};
Elm['Explanation']['Naive'] = Elm['Explanation']['Naive'] || {};
if (typeof _user$project$Explanation_Naive$main !== 'undefined') {
    _user$project$Explanation_Naive$main(Elm['Explanation']['Naive'], 'Explanation.Naive', undefined);
}
